    ...
    <div className="max-w-[1400px] mx-auto px-5 md:px-8 py-2 md:py-10 pb-bottom-nav md:pb-10">
      <div className="flex flex-col md:grid md:grid-cols-[1fr_380px] gap-6 md:gap-10 md:items-start">
        ...
        <div className="w-full md:space-y-8">
          ...
          <div className="md:rounded-2xl md:bg-card md:border md:border-border md:p-6 rounded-2xl bg-card border border-border p-6 flex items-center justify-center h-64 animate-pulse">
            <div className="w-48 h-48 rounded-full border-[18px] border-white/5" />
          </div>
        </div>
        {/* Destra */}

    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent showCloseButton={false} className="p-0 bg-[#0f0f11] border-white/[0.1]">
          ...
          {/* Avatar + email */}
          <div className="px-6 pt-2 pb-5 border-b border-white/[0.06]">
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-full bg-[var(--primary)] flex items-center justify-center shrink-0">
                <span className="font-mono text-[14px] font-bold text-[#09090b]">{initials}</span>
              </div>
              <div className="min-w-0">
                <p className="text-[14px] font-medium text-[#fafafa] tracking-[-0.1px] truncate">{email || '—'}</p>
                <p className="font-mono text-[10px] text-[#52525b] tracking-[1px] mt-0.5 uppercase">Account personale</p>
              </div>
            </div>
          </div>
          ...
          <div className="px-6 py-4 border-b border-white/[0.06]">
            <p className="font-mono text-[10px] tracking-[2px] uppercase text-[#71717a] mb-3">Tema</p>
              ...
              {THEMES.map(({ value, label, Icon }) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: active ? '#bef264' : 'rgba(255,255,255,0.03)',
          ...
          <div className="px-4 pb-4 pt-1">
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-3 rounded-xl text-[14px] text-[#71717a] hover:text-[#ef4444] hover:bg-white/[0.03] transition-colors"
            >
